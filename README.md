...
Проект создан для построения end-to-end ETL пайплайна, демонстрирующего работу с API-источником, S3-хранилищем,
Spark-трансформациями и распределённой ClickHouse-кластерной архитектурой:
